...
function StudentShell() {
	...
	const tabs = [
		...
		{ to: "/student/leaderboard", icon: <Trophy size={22} />, label: t("nav.leaderboard") },
		{ to: "/student/progress", icon: <BarChart3 size={22} />, label: t("nav.progress") },
		{
		...
		{ to: "/student/settings", icon: <Settings size={22} />, label: t("nav.settings") },
	];
	return (
