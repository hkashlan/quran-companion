...
const messages: Record<Locale, Dict> = {
	ar: {
		...
		"backlog.waive": "طيّها",
		"backlog.waiveConfirm": "تُطوى {range} ليوم {date} — لا تُخصم نقاط.",
		...
		"excuse.title": "أيام العذر",
		"excuse.button": "استئذان اليوم",
		"excuse.confirm":
			"هل تريد الاستئذان عن يوم {date}؟ لن يُكسر تتابعك ولن يُحتسب إنجازًا.",
		"excuse.reason": "السبب (اختياري)",
		"excuse.balance": "تبقّى لك {remaining} من {allowed} هذا الشهر",
		"excuse.dayLabel": "يوم مستأذَن",
		"excuse.todayExcused": "اليوم مستأذَن — تتابعك محفوظ",
		"excuse.remove": "تراجع",
		"excuse.error.future": "لا يمكن الاستئذان عن يوم لم يأتِ بعد.",
		"excuse.error.tooOld": "مضى أكثر من يوم — لا يمكن الاستئذان عنه الآن.",
		"excuse.error.noBalance": "استنفدت رصيدك لهذا الشهر.",
		"excuse.error.already": "هذا اليوم مستأذَن بالفعل.",
		"circle.excuseDays": "أيام الاستئذان شهريًا",
		"circle.excuseDaysHint": "اتركه فارغًا لاعتماد الافتراضي ({default}).",
		"detail.excuseUsage": "أيام الاستئذان",
		"detail.excuseUsed": "{used} من {allowed} هذا الشهر",
		"home.leave": "مغادرة",
		...
		"leaderboard.today": "اليوم",
		"leaderboard.ranking": "المتصدرون",
		"leaderboard.noPlanToday": "لا توجد مراجعة اليوم",
		"leaderboard.pagesDone": "{done} / {target} صفحة",
		"leaderboard.remind": "تذكير",
		"leaderboard.reminded": "تم الإرسال",
		"leaderboard.plan": "الخطة",
		"leaderboard.plus": "+{over} صفحة إضافية",
		"late.title": "الطلاب المتأخرون",
		"late.subtitle": "أرسل رسالة للطلاب الذين لم يُنهوا مراجعة اليوم",
		"late.none": "لا يوجد طلاب متأخرون 🎉",
		"late.selectAll": "تحديد الكل",
		"late.selected": "{count} محدد",
		"late.message": "الرسالة",
		"late.placeholder": "اكتب رسالتك… 😊",
		"late.send": "إرسال الرسالة",
		"late.sent": "تم إرسال الرسالة ✓",
		"late.saved": "الرسائل المحفوظة",
		"late.sendAndSave": "إرسال وحفظ كقالب",
		"late.deleteSaved": "حذف الرسالة المحفوظة",
		"done.title": "الطلاب المنجزون",
		"done.subtitle": "أرسل رسالة تهنئة للطلاب الذين أنهوا مراجعة اليوم",
		"done.none": "لم يُنهِ أحد مراجعة اليوم بعد",
		...
		"notifPrompt.title": "فعّل الإشعارات",
		"notifPrompt.body": "لنذكّرك بمراجعتك اليومية ونخبرك بجديد حلقتك.",
		"notifPrompt.cta": "تفعيل",
		...
		"settings.changeName": "تغيير الاسم",
		"name.title": "تغيير الاسم",
		"name.save": "حفظ",
		"name.done": "تم تغيير الاسم",
		"name.empty": "الرجاء إدخال الاسم",
	...
	en: {
		...
		"backlog.waiveConfirm":
			"{range} for {date} will be cleared — no points deducted.",
		"backlog.tooMany": "You have {count} overdue reviews",
		...
		"excuse.title": "Excuse days",
		"excuse.button": "Excuse today",
		"excuse.confirm":
			"Excuse {date}? Your streak won't break, and the day won't count as an achievement.",
		"excuse.reason": "Reason (optional)",
		"excuse.balance": "{remaining} of {allowed} left this month",
		"excuse.dayLabel": "Excused",
		"excuse.todayExcused": "Today is excused — your streak is safe",
		"excuse.remove": "Undo",
		"excuse.error.future": "You can't excuse a day that hasn't happened yet.",
		"excuse.error.tooOld":
			"More than a day has passed — too late to excuse it.",
		"excuse.error.noBalance": "You've used up this month's allowance.",
		"excuse.error.already": "That day is already excused.",
		"circle.excuseDays": "Excuse days per month",
		"circle.excuseDaysHint": "Leave empty to use the default ({default}).",
		"detail.excuseUsage": "Excuse days",
		"detail.excuseUsed": "{used} of {allowed} this month",
		"home.leave": "Leave",
		...
		"leaderboard.noPlanToday": "No review today",
		"leaderboard.pagesDone": "{done} / {target} pages",
		"leaderboard.remind": "Remind",
		"leaderboard.reminded": "Sent",
		"leaderboard.plan": "Plan",
		"leaderboard.plus": "+{over} extra pages",
		"late.title": "Late students",
		"late.subtitle": "Message students who haven't finished today's review",
		"late.none": "No late students 🎉",
		"late.selectAll": "Select all",
		"late.selected": "{count} selected",
		"late.message": "Message",
		"late.placeholder": "Write your message… 😊",
		"late.send": "Send message",
		"late.sent": "Message sent ✓",
		"late.saved": "Saved messages",
		"late.sendAndSave": "Send and save it as template",
		"late.deleteSaved": "Delete saved message",
		"done.title": "Finished students",
		"done.subtitle": "Congratulate students who finished today's review",
		"done.none": "Nobody has finished today's review yet",
		...
		"notifPrompt.title": "Turn on notifications",
		"notifPrompt.body":
			"So we can remind you about your daily review and your circle's news.",
		"notifPrompt.cta": "Enable",
	...
	de: {
		...
		"nav.myStudents": "Meine Schüler",
		"nav.asStudent": "Als Schüler",
		...
		"backlog.waiveConfirm":
			"{range} für {date} wird gestrichen — keine Punkte abgezogen.",
		"backlog.tooMany": "Du hast {count} überfällige Wiederholungen",
		...
		"excuse.title": "Entschuldigungstage",
		"excuse.button": "Heute entschuldigen",
		"excuse.confirm":
			"{date} entschuldigen? Deine Serie bricht nicht, der Tag zählt aber auch nicht als Leistung.",
		"excuse.reason": "Grund (optional)",
		"excuse.balance": "Noch {remaining} von {allowed} diesen Monat",
		"excuse.dayLabel": "Entschuldigt",
		"excuse.todayExcused":
			"Heute ist entschuldigt — deine Serie bleibt erhalten",
		"excuse.remove": "Rückgängig",
		"excuse.error.future":
			"Ein Tag in der Zukunft kann nicht entschuldigt werden.",
		"excuse.error.tooOld": "Mehr als ein Tag ist vergangen — zu spät dafür.",
		"excuse.error.noBalance":
			"Dein Kontingent für diesen Monat ist aufgebraucht.",
		"excuse.error.already": "Dieser Tag ist bereits entschuldigt.",
		"circle.excuseDays": "Entschuldigungstage pro Monat",
		"circle.excuseDaysHint": "Leer lassen für den Standard ({default}).",
		"detail.excuseUsage": "Entschuldigungstage",
		"detail.excuseUsed": "{used} von {allowed} diesen Monat",
		...
		"leaderboard.ranking": "Rangliste",
		"leaderboard.noPlanToday": "Heute keine Wiederholung",
		"leaderboard.pagesDone": "{done} / {target} Seiten",
		"leaderboard.remind": "Erinnern",
		"leaderboard.reminded": "Gesendet",
		"leaderboard.plan": "Plan",
		"leaderboard.plus": "+{over} Seiten extra",
		"late.title": "Verspätete Schüler",
		"late.subtitle": "Schreibe Schülern, die heute noch nicht fertig sind",
		"late.none": "Keine verspäteten Schüler 🎉",
		"late.selectAll": "Alle auswählen",
		"late.selected": "{count} ausgewählt",
		"late.message": "Nachricht",
		"late.placeholder": "Schreibe deine Nachricht… 😊",
		"late.send": "Nachricht senden",
		"late.sent": "Nachricht gesendet ✓",
		"late.saved": "Gespeicherte Nachrichten",
		"late.sendAndSave": "Senden und als Vorlage speichern",
		"late.deleteSaved": "Gespeicherte Nachricht löschen",
		"done.title": "Fertige Schüler",
		"done.subtitle":
			"Gratuliere Schülern, die die heutige Wiederholung geschafft haben",
		"done.none": "Noch hat niemand die heutige Wiederholung geschafft",
		...
		"notifPrompt.title": "Mitteilungen aktivieren",
		"notifPrompt.body":
			"Damit wir dich an deine tägliche Wiederholung und Neues aus deinem Kreis erinnern können.",
		"notifPrompt.cta": "Aktivieren",
		...
		"settings.changeName": "Namen ändern",
		"name.title": "Namen ändern",
		"name.save": "Speichern",
		"name.done": "Name aktualisiert",
