...
/** Inherits the surrounding text color, so it stays visible on any button variant. */
export function Spinner() {
	return (
		<span className="inline-block h-5 w-5 animate-spin rounded-full border-2 border-current/40 border-t-current" />
	);
}
